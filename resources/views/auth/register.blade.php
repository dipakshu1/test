                    ...
                    <div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-2">
                        ...
                        <div class="d-flex flex-center flex-column flex-lg-row-fluid">
                            ...
                            <div class="w-lg-500px p-10">
                                <!--begin::Form-->
                                <form method="POST"  class="form w-100" novalidate="novalidate" id="kt_sign_in_form" action="{{ route('register') }}" >
                                    @csrf
                                    <!--begin::Heading-->
                                    ...
                                    <div class="fv-row mb-8">
                                        <input name="name" id="name" type="text" placeholder="Name" class="form-control bg-transparent"  value="{{ old('name') }}" required autocomplete="name" autofocus>
                                    </div>
                                    <div class="fv-row mb-8">
                                ...
                                <input id="password" type="password" placeholder="Password" class="form-control bg-transparent " name="password" required autocomplete="current-password">
                                    ...
                                    <!--end::Input group=-->
                                    <!--begin::Submit button-->
                                    <div class="d-grid mt-5 py-5 mb-10">
